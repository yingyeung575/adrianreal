  ...
  <main style="width:100%" id='rightside'>
            ...
            <nav class="s-tabs padding-top-sm padding-left-sm">
              ...
              <ul class="s-tabs__list">
                ...
                <li><nuxt-link class="s-tabs__item--selected" to="/school-type/summer-school">遊學團</nuxt-link></li>
              </ul>
                        ...
                        <div class="col-5@md">
                          <div class="jschollright padding-top-xs">
                            <div class="showstat" style="padding-left:1em">
                              <h4 class="text-sm">距離倫敦車程約</h4>
                              <h3 v-if='!list.nearlondon' class='text-xl jthebg color-accent text-center'>-</h3>
                              <h3 v-if='list.nearlondon' class='text-xl jthebg color-accent'>{{ list.nearlondon }}mins</h3>
                            </div>
                            <div class="showstat">
                              <h4   class="text-sm">距離曼徹斯特車程約</h4>
                              <h3 v-if='list.nearmanchester' class='text-xl jthebg color-accent'>{{ list.nearmanchester }}mins</h3>    
