                  ...
                  <div class='mschool' v-if='showing > idx'>
                    <div class="grid grid-gap-md">
                        <div class="text-left col-7@md padding-y-md padding-x-lg">
                          ...
                          <img :src='backendurl2  + list.university.image.url' width='100' v-if='list.university.image'>
                          ...
                          <nuxt-link v-if='list.university.isfoundation' :to="'/foundation/' + list.university.slug+'-foundation'" class="margin-left-sm btn btn--primary btn--sm">查看Foundation</nuxt-link>
                          <nuxt-link v-if='list.university.isinternational1' :to="'/international-one/' + list.university.slug + '-international-year-one'" class="margin-left-sm btn btn--accent btn--sm">查看International Year 1</nuxt-link>
                        </div>
                        <div class="col-5@md">
 ...
 //   return { subjects }
  ...
  async created(){
     ...
     if (this.$store.state.schools.university)
       ...
       this.subjects = await this.$axios.$get(process.env.backendurl2+'subjects?isuniversity_eq=true') 
  ...
  methods:{
    ...
    onChange(event) {
         window.location.href = this.frontendurl + 'school-type/university?subject=' + event.target.value
        ...
        funiversities = funiversities.filter(
          ...
          x => {
            ...
            */
            ...
            // and check
              const schooloption = x.university.option.map(x => x.name)
